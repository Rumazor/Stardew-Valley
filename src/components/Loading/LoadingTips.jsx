...
const tips = [  "La mayoría de las granjas de pollo tienen más de 200,000 aves en un solo lugar.",  "Las vacas pueden sentir emociones como la tristeza y la felicidad.",  "Los cerdos son animales inteligentes y sociales que pueden aprender rápidamente.",  "Las abejas son esenciales para la polinización y la producción de alimentos.",  "Las gallinas pueden distinguir hasta 100 caras diferentes de otros animales y personas.",  "Los caballos pueden comunicarse entre ellos y con otros animales con más de 30 sonidos diferentes.",  "Las ovejas son capaces de reconocer y recordar el rostro de otros ovejas y humanos por más de un año.",  "Los cabritos nacen sin inmunidad natural y deben obtenerla de su madre a través de la leche materna.",  "Las granjas de vacas lecheras pueden tener hasta 10,000 vacas en un solo lugar.",  "Las granjas de cerdo son a menudo altamente intensivas y los cerdos pueden vivir en espacios muy pequeños.", "¿Sabias que el caballo de Mashwim se llama Rocinante al igual que el caballo de Don quijote?"]
...
const LoadingTips = () => {
  ...
  return (
    <div className='flex justify-center animate__animated animate__fadeIn   '>
        ...
        <img src={Chicken} className='absolute -bottom-12 right-60 ' alt="text box" />
        </div>
    </div>
  )
}
