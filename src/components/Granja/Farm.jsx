...
switch (index) {
  ...
  return (
     <section className="h-screen overflow-hidden bg-black farm-font">
       <div className={`grid place-content-center ${showScene} animate__animated animate__fadeIn animate__slower `}>
